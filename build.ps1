...
wsl docker run -it --rm `
    ...
    -w /ansible `
    ansible:latest ansible-playbook -vvvv -f 10 -i inventory.yaml -l test-zfs.valewood.lab,test-btrfs.valewood.lab -e create_image=false --vault-password-file /vault-password-file arch_fresh_install.yaml
